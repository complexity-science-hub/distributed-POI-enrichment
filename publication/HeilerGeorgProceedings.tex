...
% Put the number of events per user in each caption, to avoid too much searching around by the reader. 
% Are these the "Configurations" described on the previous page?
% Vague. Put the exact number. 
%xxxxxxxxxxxxxxxx
% I don't understand this. Methodologies (1) and (2) don't appear in Figure 4. 
% Not clear what this is. Never mentioned before. 
